...
b,c.right):this.ptNode(a,b,c.left)},add_segment:function(a){function b(a){f.vLow==r.vLow&&q?f.rseg==p?(a.u0=m,m.setBelow(a,null),n.setBelow(null,null)):(a.u1=n,n.setBelow(a,null),m.setBelow(null,null)):(a.u0&&a.u1&&(a.u0==f?(a.usave=a.u1,a.uside=PNLTRI.S_LEFT):(a.usave=a.u0,a.uside=PNLTRI.S_RIGHT)),a.setAbove(m,n),m.setBelow(a,null),n.setBelow(a,null))}function c(){var b;f.vLow==r.vLow&&q?(f.d0.setAbove(m,null),f.d1.setAbove(n,null),b=f.d1,m.setBelow(f.d0,null),n.setBelow(b,null),b=null):0<d.is_left_of(a,
f.vLow,!0)?(b=f.d1,f.d0.setAbove(m,null),f.d1.setAbove(m,n),m.setBelow(f.d0,f.d1),n.setBelow(f.d1,null)):(b=f.d0,f.d0.setAbove(m,n),f.d1.setAbove(n,null),n.setBelow(f.d0,f.d1),m.setBelow(f.d0,null));return b}var d=this,e,k,l,h,g,p;a.upward?(h=a.vFrom,e=a.vTo,g=a.rootFrom,k=a.rootTo,p=a.sprev,l=a.snext):(h=a.vTo,e=a.vFrom,g=a.rootTo,k=a.rootFrom,p=a.snext,l=a.sprev);var q=!1;k=this.ptNode(e,h,k);l.is_inserted||(k=this.splitNodeAtPoint(k,e,!1));var f=k.trap;k=this.ptNode(h,e,g);p.is_inserted?q=!0:k=
this.splitNodeAtPoint(k,h,!0);var r=k.trap,m,n,s,t;for(e=this.trapezoids.length+2;f;){if(0>--e){console.log("ERR add_segment: infinite loop",f,a,this);return}if(!f.d0&&!f.d1){console.log("ERR add_segment: missing successors",f,a,this);return}l=f.sink;l.nodetype=PNLTRI.T_X;l.seg=a;l.trap=null;h=g=!0;t&&t.rseg==f.rseg?(g=!1,m=f,n=t,n.vLow=f.vLow,l.right=t.sink,m.sink=l.newLeft(PNLTRI.T_SINK,m)):s&&s.lseg==f.lseg?(h=!1,n=f,m=s,m.vLow=f.vLow,l.left=s.sink,n.sink=l.newRight(PNLTRI.T_SINK,n)):(m=f,n=this.cloneTrap(f),
n.sink=l.newRight(PNLTRI.T_SINK,n),m.sink=l.newLeft(PNLTRI.T_SINK,m));f.u0&&f.u1?f.usave?(f.uside==PNLTRI.S_LEFT?(g&&(n.setAbove(f.u1,f.usave),n.u0.d0=n,n.u1.d0=n),h&&(m.u1=null,m.u0.d0=m)):(g&&(n.setAbove(f.u1,null),n.u0.d0=n),h&&(m.setAbove(f.usave,f.u0),m.u0.d0=m,m.u1.d0=m)),m.usave=n.usave=null):(g&&(n.setAbove(f.u1,null),n.u0.d0=n),h&&(m.u1=null)):f.u0.d0&&f.u0.d1?f==f.u0.d1?(g&&(n.u0.d1=n,n.u1=null),h&&m.setAbove(null,null)):(g&&n.setAbove(null,null),h&&(m.u0.d0=m,m.u1=null)):h&&m.u0.setBelow(m,
n);f.d0&&f.d1?l=c():(l=f.d0?f.d0:f.d1,b(l));m.rseg=n.lseg=a;f.vLow!=r.vLow?(s=m,t=n,f=l):f=null}a.is_inserted=!0},find_first_inside:function(){for(var a=0,b=this.trapezoids.length;a<b;a++)if(this.inside_polygon(this.trapezoids[a]))return this.trapezoids[a];return null},update_trapezoids:function(){for(var a,b=0,c=this.trapezoids.length;b<c;b++)a=this.trapezoids[b],a.u0&&a.u1?a.topLoc=PNLTRI.TRAP_MIDDLE:a.lseg&&a.vHigh==a.lseg.vFrom?a.topLoc=a.u0||a.u1?PNLTRI.TRAP_LEFT:PNLTRI.TRAP_CUSP:a.rseg?a.topLoc=
PNLTRI.TRAP_RIGHT:a.lseg&&a.vHigh==a.lseg.vTo&&(a.topLoc=PNLTRI.TRAP_LEFT),a.d0&&a.d1?a.botLoc=PNLTRI.TRAP_MIDDLE:a.lseg&&a.vLow==a.lseg.vTo?a.botLoc=a.d0||a.d1?PNLTRI.TRAP_LEFT:PNLTRI.TRAP_CUSP:a.rseg?a.botLoc=PNLTRI.TRAP_RIGHT:a.lseg&&a.vLow==a.lseg.vFrom&&(a.botLoc=PNLTRI.TRAP_LEFT)}};PNLTRI.Trapezoider=function(a){this.polyData=a;this.queryStructure=new PNLTRI.QueryStructure(this.polyData)};
...
b,c,d,e){function k(a){for(var b=a.length-1;0<=b;b--)l.unshift(a[b])}var l=[],h=[];null==c&&(d=!0,b.u0?c=!0:b.d0?c=!1:(d=!1,c=b.u1?!0:!1));for(k([[b,c,d,a]]);h=l.shift();){var g;if((g=h[0])&&!g.monoDiag){if(!g.lseg||!g.rseg)return console.log("ERR alyTrap: lseg/rseg missing",g),g.monoDiag=PNLTRI.TRAP_NOSPLIT,l;a=h[1];b=h[2];var h=h[3],p;p=g.vHigh;var q=g.vLow,f=null,r,m;g.topLoc==PNLTRI.TRAP_MIDDLE&&(f=!0,r=g.u0,m=g.u1);g.botLoc==PNLTRI.TRAP_MIDDLE&&(f=!1,r=g.d0,m=g.d1);g.monoDiag=1+4*g.topLoc+g.botLoc;
null!=f?g.topLoc==PNLTRI.TRAP_CUSP||g.botLoc==PNLTRI.TRAP_CUSP?(p=this.doSplit(h,q,p,b),k([[b?r:m,!a,b,h],[b?m:r,!a,!b,p]])):g.topLoc==PNLTRI.TRAP_MIDDLE&&g.botLoc==PNLTRI.TRAP_MIDDLE?(p=this.doSplit(h,q,p,b),b||(a=p,p=h,h=a),k([[g.u0,!1,!0,h],[g.d0,!0,!0,h],[g.u1,!1,!1,p],[g.d1,!0,!1,p]])):(f?(c=g.d0?g.d0:g.d1,d=g.botLoc==PNLTRI.TRAP_LEFT):(c=g.u0?g.u0:g.u1,d=g.topLoc==PNLTRI.TRAP_LEFT),a==f&&b==d?h=this.doSplit(h,q,p,d):(p=this.doSplit(h,q,p,!d),k([[d?r:m,!f,d,p]])),k([[d?m:r,!f,!d,h],[c,f,!d,h]])):
(g.topLoc==PNLTRI.TRAP_CUSP||g.botLoc==PNLTRI.TRAP_CUSP?g.monoDiag=PNLTRI.TRAP_NOSPLIT:(g.topLoc==g.botLoc?g.monoDiag=PNLTRI.TRAP_NOSPLIT:h=g.topLoc==PNLTRI.TRAP_LEFT?this.doSplit(h,q,p,!a):this.doSplit(h,q,p,a),a=!a),a?(c=g.u0?g.u0:g.u1,d=g.topLoc==PNLTRI.TRAP_LEFT):(c=g.d0?g.d0:g.d1,d=g.botLoc==PNLTRI.TRAP_LEFT),k([[c,!a,!d,h]]))}if(e)return l}return[]}};PNLTRI.MonoTriangulator=function(a){this.polyData=a};
