...
c,b){function d(a,b){for(var c,d,f=null,e=4,g=0;g<a.outSegs.length;g++){c=a.outSegs[g];var k=c.vertTo;d=k.x-a.x;var k=k.y-a.y,h=b.x-a.x,u=b.y-a.y,x=(d*h+k*u)/Math.sqrt(d*d+k*k)/Math.sqrt(h*h+u*u);(d=0<=d*u-h*k?1-x:3+x)<e&&(e=d,f=c)}return f}var e=d(c,b),g=d(b,c),e=e.segOut,g=g.segOut,h=1==this.compare_pts_yx(c,b),k=this.appendSegmentEntry({vFrom:c,vTo:b,upward:!h,mprev:e.mprev,mnext:g}),h=this.appendSegmentEntry({vFrom:b,vTo:c,upward:h,mprev:g.mprev,mnext:e});e.mprev.mnext=k;g.mprev.mnext=h;e.mprev=
h;g.mprev=k;this.appendVertexOutsegEntry(c,{segOut:k,vertTo:b});this.appendVertexOutsegEntry(b,{segOut:h,vertTo:c});this.monoSubPolyChains[a]=g;this.monoSubPolyChains.push(e);return this.monoSubPolyChains.length-1},unique_monotone_chains_max:function(){var a,c,b,d,e,g;for(g=0;g<this.segments.length;g++)this.segments[g].marked=!1;var h=[];for(g=0;g<this.monoSubPolyChains.length;g++){a=c=this.monoSubPolyChains[g];d=e=a.vFrom;a.marked=!0;a=a.mnext;for(var k=!1;(b=a.vFrom)!=d;){if(a.marked){k=!0;break}else a.marked=
!0;1==this.compare_pts_yx(b,e)&&(e=b,c=a);a=a.mnext}k||h.push(c)}return h},normalize_monotone_chains:function(){this.monoSubPolyChains=this.unique_monotone_chains_max();return this.monoSubPolyChains.length},clearTriangles:function(){this.triangles=[]},addTriangle:function(a,c,b){this.triangles.push([a.id,c.id,b.id])}};PNLTRI.BasicTriangulator=function(a){this.polyData=a};
PNLTRI.BasicTriangulator.prototype={constructor:PNLTRI.BasicTriangulator,triangulate_polygon_no_holes:function(){function a(a,b,c,d,e){var f=a[b].x;b=a[b].y;var g=a[c].x;c=a[c].y;var h=a[d].x;d=a[d].y;if(PNLTRI.Math.EPSILON_P>(g-f)*(d-b)-(c-b)*(h-f))return!1;var s,t,u,x,D,E;s=h-g;t=d-c;u=f-h;x=b-d;D=g-f;E=c-b;var y,v,w,z,A,B,C;for(y=0;y<e;y++)if(v=a[y].x,w=a[y].y,z=v-f,A=w-b,0!=z||0!=A)if(B=v-g,C=w-c,0!=B||0!=C)if(v-=h,w-=d,0!=v||0!=w)if(B=s*C-t*B,z=D*A-E*z,A=u*w-x*v,B>=PNLTRI.Math.EPSILON_N&&A>=
PNLTRI.Math.EPSILON_N&&z>=PNLTRI.Math.EPSILON_N)return!1;return!0}var c=function(a){var b=[],c=0,d=a,e,f,g=0;do e=d.sprev.vFrom,f=d.vFrom,c+=e.x*f.y-f.x*e.y,b[g++]=f,d=d.snext;while(d!=a);0>c&&(b=b.reverse());return b}(this.polyData.getSegments()[0]),b=c.length,d,e,g,h=2*b;for(e=b-1;2<b;){if(0>=h--)return!1;d=e;b<=d&&(d=0);e=d+1;b<=e&&(e=0);g=e+1;b<=g&&(g=0);if(a(c,d,e,g,b)){this.polyData.triangles.push([c[d].id,c[e].id,c[g].id]);d=e;for(g=e+1;g<b;d++,g++)c[d]=c[g];b--;h=2*b}}return!0}};PNLTRI.trapCnt=0;PNLTRI.Trapezoid=function(a,c,b,d){this.trapID=PNLTRI.trapCnt++;this.vHigh=a?a:{x:Number.POSITIVE_INFINITY,y:Number.POSITIVE_INFINITY};this.vLow=c?c:{x:Number.NEGATIVE_INFINITY,y:Number.NEGATIVE_INFINITY};this.lseg=b;this.rseg=d;this.depth=-1;this.monoDiag=null};
...
doSplit:function(a,c,b,d){return d?this.polyData.splitPolygonChain(a,c,b):this.polyData.splitPolygonChain(a,b,c)},alyTrap:function(a,c,b,d,e){function g(){var a;return(a=h.pop())?(k=a[0],n=a[1],p=a[2],q=a[3],!0):!1}var h=[],k,n,p,q,r;null==b&&(d=!0,c.uL?b=!0:c.dL?b=!1:(d=!1,b=c.uR?!0:!1));for(c&&h.push([c,b,d,a]);g();)if(!k.monoDiag){if(!k.lseg||!k.rseg)return console.log("ERR alyTrap: lseg/rseg missing",k),h;n?p?(a=k.uL,c=k.uR,b=k.dL,d=k.dR):(a=k.uR,c=k.uL,b=k.dR,d=k.dL):p?(a=k.dL,c=k.dR,b=k.uL,
d=k.uR):(a=k.dR,c=k.dL,b=k.uR,d=k.uL);if(c||d)r=this.doSplit(q,k.vLow,k.vHigh,p);d&&h.push([d,n,!p,r]);c&&h.push([c,!n,!p,r]);b&&h.push([b,n,p,q]);b||d||a&&h.push([a,!n,p,q]);k.monoDiag=!0;if(e)return h}return[]}};PNLTRI.MonoTriangulator=function(a){this.polyData=a};
