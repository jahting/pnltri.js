...
PNLTRI.Trapezoid.prototype={constructor:PNLTRI.Trapezoid,clone:function(){var a=new PNLTRI.Trapezoid(this.vHigh,this.vLow,this.lseg,this.rseg);a.uL=this.uL;a.uR=this.uR;a.u0=this.uL;a.u1=this.uR;a.topLoc=this.topLoc;a.dL=this.dL;a.dR=this.dR;a.d0=this.dL;a.d1=this.dR;a.botLoc=this.botLoc;a.sink=this.sink;return a},setAbove:function(a,b){this.uL=a;this.uR=b;this.u0=a;this.u1=b},setBelow:function(a,b){this.dL=a;this.dR=b;this.d0=a;this.d1=b},setSink:function(a){this.sink=a},replaceAbove:function(a,
b){this.uL==a?this.u0=this.uL=b:this.uR==a&&(this.u1=this.uR=b)},splitOffLower:function(a){var b=this.clone();this.vLow=b.vHigh=a;this.botLoc=b.topLoc=PNLTRI.TRAP_MIDDLE;this.setBelow(b,null);b.setAbove(this,null);b.dL&&b.dL.replaceAbove(this,b);b.dR&&b.dR.replaceAbove(this,b);return b}};PNLTRI.T_Y=1;PNLTRI.T_X=2;PNLTRI.T_SINK=3;PNLTRI.S_LEFT=1;PNLTRI.S_RIGHT=2;PNLTRI.qsCounter=0;
PNLTRI.QsNode=function(a,b,c){this.qsNodeID=PNLTRI.qsCounter++;this.nodetype=a;c&&(a==PNLTRI.T_Y?this.yval=c:a==PNLTRI.T_X?this.seg=c:this.trap=c)};PNLTRI.QsNode.prototype={constructor:PNLTRI.QsNode,newRight:function(a,b){return this.right=new PNLTRI.QsNode(a,this,b)},newLeft:function(a,b){return this.left=new PNLTRI.QsNode(a,this,b)}};
...
1;0<=b;b--)m.unshift(a[b])}var m=[],l=[];null==c&&(d=!0,b.u0?c=!0:b.d0?c=!1:(d=!1,c=b.u1?!0:!1));for(n([[b,c,d,a]]);l=m.shift();){var f;if((f=l[0])&&!f.monoDiag){if(!f.lseg||!f.rseg)return console.log("ERR alyTrap: lseg/rseg missing",f),f.monoDiag=PNLTRI.TRAP_NOSPLIT,m;a=l[1];b=l[2];var l=l[3],p;p=f.vHigh;var r=f.vLow,q=null,s,g;f.topLoc==PNLTRI.TRAP_MIDDLE&&(q=!0,s=f.u0,g=f.u1);f.botLoc==PNLTRI.TRAP_MIDDLE&&(q=!1,s=f.d0,g=f.d1);f.monoDiag=1+4*f.topLoc+f.botLoc;null!=q?f.topLoc==PNLTRI.TRAP_CUSP||
f.botLoc==PNLTRI.TRAP_CUSP?(p=this.doSplit(l,r,p,b),n([[b?s:g,!a,b,l],[b?g:s,!a,!b,p]])):f.topLoc==PNLTRI.TRAP_MIDDLE&&f.botLoc==PNLTRI.TRAP_MIDDLE?(p=this.doSplit(l,r,p,b),b||(a=p,p=l,l=a),n([[f.u0,!1,!0,l],[f.d0,!0,!0,l],[f.u1,!1,!1,p],[f.d1,!0,!1,p]])):(q?(c=f.d0?f.d0:f.d1,d=f.botLoc==PNLTRI.TRAP_LEFT):(c=f.u0?f.u0:f.u1,d=f.topLoc==PNLTRI.TRAP_LEFT),a==q&&b==d?l=this.doSplit(l,r,p,d):(p=this.doSplit(l,r,p,!d),n([[d?s:g,!q,d,p]])),n([[d?g:s,!q,!d,l],[c,q,!d,l]])):(f.topLoc==PNLTRI.TRAP_CUSP||f.botLoc==
PNLTRI.TRAP_CUSP?f.monoDiag=PNLTRI.TRAP_NOSPLIT:(f.topLoc==f.botLoc?f.monoDiag=PNLTRI.TRAP_NOSPLIT:l=f.topLoc==PNLTRI.TRAP_LEFT?this.doSplit(l,r,p,!a):this.doSplit(l,r,p,a),a=!a),a?(c=f.u0?f.u0:f.u1,d=f.topLoc==PNLTRI.TRAP_LEFT):(c=f.d0?f.d0:f.d1,d=f.botLoc==PNLTRI.TRAP_LEFT),n([[c,!a,!d,l]]))}if(e)return m}return[]}};PNLTRI.MonoTriangulator=function(a){this.polyData=a};
