...
0==this.monoSubPolyChains.length&&(this.monoSubPolyChains=[this.segments[0]]);return a},addVertexChain:function(a){function b(a,b){return Math.abs(a.x-b.x)<PNLTRI.Math.EPSILON_P&&Math.abs(a.y-b.y)<PNLTRI.Math.EPSILON_P}for(var c=[],d,e,k,g=0;g<a.length;g++)d=this.appendVertexEntry({x:a[g].x,y:a[g].y}),e=!0,k=c.length-1,0<=k&&b(d,c[k])&&(e=!1),e&&c.push(d);1<c.length&&b(c[c.length-1],c[0])&&c.pop();return c},addPolygonChain:function(a){a=this.addVertexChain(a);if(3>a.length)return console.log("Polygon has < 3 vertices!",
a),0;for(var b=this.segments.length,c,d,e,k=0;k<a.length-1;k++)c=this.createSegmentEntry(a[k],a[k+1]),e?(c.sprev=e,e.snext=c):d=c,e=c,this.appendSegmentEntry(c);c=this.createSegmentEntry(a[a.length-1],a[0]);c.sprev=e;e.snext=c;this.appendSegmentEntry(c);d.sprev=c;c.snext=d;this.PolyLeftArr[this.idNextPolyChain++]=!0;return this.segments.length-b},reverse_polygon_chain:function(a){this.set_PolyLeft_wrong(a.chainId);var b,c=a;do b=c.snext,c.snext=c.sprev,c.sprev=b,b=c.vTo,c.vTo=c.vFrom,c.vFrom=b,c.upward=
!c.upward,c=c.sprev;while(c!=a)},initMonoChains:function(){for(var a=0;a<this.segments.length;a++)this.segments[a].marked=!1,this.segments[a].mprev=this.segments[a].sprev,this.segments[a].mnext=this.segments[a].snext,this.segments[a].vFrom.outSegs=[{segOut:this.segments[a],vertTo:this.segments[a].vTo}]},appendVertexOutsegEntry:function(a,b){var c=b?b:{segOut:null,vertTo:null};a.outSegs.push(c);return c},splitPolygonChain:function(a,b,c,d,e){function k(a,b,c){function d(a,b,c){var e=b.x-a.x;b=b.y-
a.y;var f=c.x-a.x;a=c.y-a.y;c=(e*f+b*a)/Math.sqrt(e*e+b*b)/Math.sqrt(f*f+a*a);return 0<=e*a-f*b?1-c:3+c}var e,g=null;if(c)for(var k=0,h=0;h<a.outSegs.length;h++)c=a.outSegs[h],(e=d(a,c.vertTo,b))>k&&(k=e,g=c);else for(k=4,h=0;h<a.outSegs.length;h++)c=a.outSegs[h],(e=d(a,c.vertTo,b))<k&&(k=e,g=c);return g}var g=k(b,c,e);e=k(c,b,e);var g=g.segOut,h=e.segOut,n=-1==this.compare_pts_yx(b,c);e=this.appendSegmentEntry({vFrom:b,vTo:c,upward:n,mprev:g.mprev,mnext:h});n=this.appendSegmentEntry({vFrom:c,vTo:b,
upward:!n,mprev:h.mprev,mnext:g});g.mprev.mnext=e;h.mprev.mnext=n;g.mprev=n;h.mprev=e;this.appendVertexOutsegEntry(b,{segOut:e,vertTo:c});this.appendVertexOutsegEntry(c,{segOut:n,vertTo:b});b=this.monoSubPolyChains.length;d?(this.monoSubPolyChains[a]=e,this.monoSubPolyChains[b]=n):(this.monoSubPolyChains[a]=n,this.monoSubPolyChains[b]=e);return b},unique_monotone_chains_max:function(){var a,b,c,d,e,k;for(k=0;k<this.segments.length;k++)this.segments[k].marked=!1;var g=[];for(k=0;k<this.monoSubPolyChains.length;k++){a=
b=this.monoSubPolyChains[k];d=e=a.vFrom;a.marked=!0;a=a.mnext;for(var h=!1;(c=a.vFrom)!=d;){if(a.marked){h=!0;break}else a.marked=!0;1==this.compare_pts_yx(c,e)&&(e=c,b=a);a=a.mnext}h||g.push(b)}return g},normalize_monotone_chains:function(){this.monoSubPolyChains=this.unique_monotone_chains_max();return this.monoSubPolyChains.length},clearTriangles:function(){this.triangles=[]},addTriangle:function(a,b,c){this.triangles.push([a.id,b.id,c.id])}};PNLTRI.EarClipTriangulator=function(a){this.polyData=a};
PNLTRI.EarClipTriangulator.prototype={constructor:PNLTRI.EarClipTriangulator,triangulate_polygon_no_holes:function(){var a=this.polyData,b=a.getFirstSegment(),c=b;if(a.isClockWise(b)){do c.mprev=c.snext,c=c.mnext=c.sprev;while(c!=b);a.set_PolyLeft_wrong(0)}else{do c.mprev=c.sprev,c=c.mnext=c.snext;while(c!=b)}for(b=a=b;a.mnext!=a.mprev;){a:{var c=a.mprev.vFrom.x,d=a.mprev.vFrom.y,e=a.vFrom.x,k=a.vFrom.y,g=a.mnext.vFrom.x,h=a.mnext.vFrom.y,n=g-e,p=h-k,q=c-g,t=d-h,f=e-c,m=k-d;if(PNLTRI.Math.EPSILON_P>
f*p-n*m)c=!1;else{for(var l=a.mprev.mprev,s=a.mnext;s!=l;){var s=s.mnext,r=s.vFrom.x,u=s.vFrom.y,v=r-c,w=u-d;if(0!=v||0!=w){var x=r-e,y=u-k;if(0!=x||0!=y)if(r-=g,u-=h,(0!=r||0!=u)&&n*y-p*x>=PNLTRI.Math.EPSILON_N&&f*w-m*v>=PNLTRI.Math.EPSILON_N&&q*u-t*r>=PNLTRI.Math.EPSILON_N){c=!1;break a}}}c=!0}}if(c)this.polyData.addTriangle(a.mprev.vFrom,a.vFrom,a.mnext.vFrom),a.mprev.mnext=a.mnext,a.mnext.mprev=a.mprev,b=a=a.mnext;else if(a=a.mnext,a==b)return!1}return!0}};PNLTRI.trapCnt=0;PNLTRI.Trapezoid=function(a,b,c,d){this.trapID=PNLTRI.trapCnt++;this.vHigh=a?a:{x:Number.POSITIVE_INFINITY,y:Number.POSITIVE_INFINITY};this.vLow=b?b:{x:Number.NEGATIVE_INFINITY,y:Number.NEGATIVE_INFINITY};this.lseg=c;this.rseg=d;this.depth=-1;this.monoDiag=null};
...
l)):(l.setAbove(null,null),m.setAbove(a,null),a.setBelow(m,a.dR)):(m.setAbove(a,null),l.setAbove(null,a),a.setBelow(m,l))}function c(a){f.vLow==t.vLow&&q?f.dL?(m.setBelow(a,null),l.setBelow(null,null),a.setAbove(m,a.uR)):(l.setBelow(null,a),m.setBelow(null,null),a.setAbove(a.uL,l)):(a.uL&&a.uR?a.uL==f?(a.usave=a.uR,a.uside=PNLTRI.S_LEFT,m.setBelow(a,null),l.setBelow(a,null)):(a.usave=a.uL,a.uside=PNLTRI.S_RIGHT,m.setBelow(null,a),l.setBelow(null,a)):f.vLow==t.vLow?(m.setBelow(a,null),l.setBelow(null,
a)):(m.setBelow(null,a),l.setBelow(a,null)),a.setAbove(m,l))}function d(){var b;f.vLow==t.vLow&&q?(f.dL.setAbove(m,null),f.dR.setAbove(null,l),b=f.dR,m.setBelow(f.dL,null),l.setBelow(null,b),b=null):0<e.is_left_of(a,f.vLow,!0)?(b=f.dR,f.dL.setAbove(m,null),f.dR.setAbove(m,l),m.setBelow(f.dL,f.dR),l.setBelow(null,f.dR)):(b=f.dL,f.dL.setAbove(m,l),f.dR.setAbove(null,l),l.setBelow(f.dL,f.dR),m.setBelow(f.dL,null));return b}var e=this,k,g,h,n,p,q;a.upward?(n=a.vFrom,k=a.vTo,p=a.rootFrom,g=a.rootTo,q=
a.sprev.is_inserted,h=a.snext.is_inserted):(n=a.vTo,k=a.vFrom,p=a.rootTo,g=a.rootFrom,q=a.snext.is_inserted,h=a.sprev.is_inserted);g=this.ptNode(k,n,g);h||(g=this.splitNodeAtPoint(g,k,!1));h=g.trap;if(h.uL||h.uR){g=this.ptNode(n,k,p);q||(g=this.splitNodeAtPoint(g,n,!0));var t=g.trap,f=h,m,l,s,r;for(k=this.trapArray.length+2;f;){if(0>--k){console.log("ERR add_segment: infinite loop",f,a,this);return}if(!f.dL&&!f.dR){console.log("ERR add_segment: missing successors",f,a,this);return}g=f.sink;g.nodetype=
...
doSplit:function(a,b,c,d){return this.polyData.splitPolygonChain(a,b,c,d)},alyTrap:function(a,b,c,d,e){function k(){var a;return(a=g.pop())?(h=a[0],n=a[1],p=a[2],q=a[3],!0):!1}var g=[],h,n,p,q,t;null==c&&(d=!0,b.uL?c=!0:b.dL?c=!1:(d=!1,c=b.uR?!0:!1));for(b&&g.push([b,c,d,a]);k();)if(!h.monoDiag){if(!h.lseg||!h.rseg)return console.log("ERR alyTrap: lseg/rseg missing",h),g;n?p?(a=h.uL,b=h.uR,c=h.dL,d=h.dR):(a=h.uR,b=h.uL,c=h.dR,d=h.dL):p?(a=h.dL,b=h.dR,c=h.uL,d=h.uR):(a=h.dR,b=h.dL,c=h.uR,d=h.uL);if(b||
d)t=this.doSplit(q,h.vLow,h.vHigh,p);d&&g.push([d,n,!p,t]);b&&g.push([b,!n,!p,t]);c&&g.push([c,n,p,q]);c||d||a&&g.push([a,!n,p,q]);h.monoDiag=!0;if(e)return g}return[]}};PNLTRI.MonoTriangulator=function(a){this.polyData=a};
