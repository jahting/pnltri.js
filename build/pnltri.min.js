...
this.splitNodeAtPoint(k,h,!0);var r=k.trap,m,n,s,t;for(e=this.trapArray.length+2;f;){if(0>--e){console.log("ERR add_segment: infinite loop",f,a,this);return}if(!f.d0&&!f.d1){console.log("ERR add_segment: missing successors",f,a,this);return}l=f.sink;l.nodetype=PNLTRI.T_X;l.seg=a;l.trap=null;h=g=!0;t&&t.rseg==f.rseg?(g=!1,m=f,n=t,n.vLow=f.vLow,l.right=t.sink,m.sink=l.newLeft(PNLTRI.T_SINK,m)):s&&s.lseg==f.lseg?(h=!1,n=f,m=s,m.vLow=f.vLow,l.left=s.sink,n.sink=l.newRight(PNLTRI.T_SINK,n)):(m=f,n=this.cloneTrap(f),
...
n);f.d0&&f.d1?l=c():(l=f.d0?f.d0:f.d1,b(l));m.rseg=n.lseg=a;f.vLow!=r.vLow?(s=m,t=n,f=l):f=null}a.is_inserted=!0},find_first_inside:function(){for(var a=0,b=this.trapArray.length;a<b;a++)if(this.inside_polygon(this.trapArray[a]))return this.trapArray[a];return null},update_trapezoids:function(){for(var a,b=0,c=this.trapArray.length;b<c;b++)a=this.trapArray[b],a.u0&&a.u1?a.topLoc=PNLTRI.TRAP_MIDDLE:a.lseg&&a.vHigh==a.lseg.vFrom?a.topLoc=a.u0||a.u1?PNLTRI.TRAP_LEFT:PNLTRI.TRAP_CUSP:a.rseg?a.topLoc=
