...
a){return Math.abs(b-a)<PNLTRI.Math.EPSILON_P},inside_polygon:function(b){var a=b.rseg;return b.lseg&&b.rseg?!b.u0&&!b.u1||!b.d0&&!b.d1?a.upward:!1:!1},is_left_of:function(b,a){var c;if(Math.abs(b.vTo.pt.y-a.y)<PNLTRI.Math.EPSILON_P)c=b.vTo.pt.x-a.x;else if(Math.abs(b.vFrom.pt.y-a.y)<PNLTRI.Math.EPSILON_P)c=b.vFrom.pt.x-a.x;else{var e;b.upward?(c=b.vFrom.pt,e=b.vTo.pt):(c=b.vTo.pt,e=b.vFrom.pt);c=PNLTRI.Math.ptsCrossProd(c,e,a)}return Math.abs(c)<PNLTRI.Math.EPSILON_P?0:c},ptNode:function(b,a,c){var e,
d=!0;switch(c.nodetype){case PNLTRI.T_SINK:return c;case PNLTRI.T_Y:e=b;e==c.yval&&(e=a);e=this.compare_pts_yx(e,c.yval);-1==e&&(d=!1);break;case PNLTRI.T_X:if(b==c.seg.vFrom.pt||b==c.seg.vTo.pt){if(this.fpEqual(b.y,a.y)){a.x<b.x&&(d=!1);break}else e=this.is_left_of(c.seg,a),0<e?d=!1:0==e&&(d=b==c.seg.vFrom.pt?!0:!1);break}else e=this.is_left_of(c.seg,b),0<e?d=!1:0==e&&(d=!0);break;default:console.log("ptNode: undef. NodeType: ",c.nodetype)}return d?this.ptNode(b,a,c.right):this.ptNode(b,a,c.left)},
add_segment:function(b){function a(a){g.loPt==v.loPt&&u?g.rseg==s?(a.u0=l,l.setBelow(a,null),k.setBelow(null,null)):(a.u1=k,k.setBelow(a,null),l.setBelow(null,null)):(a.u0&&a.u1&&(a.u0==g?(a.usave=a.u1,a.uside=PNLTRI.S_LEFT):(a.usave=a.u0,a.uside=PNLTRI.S_RIGHT)),a.setAbove(l,k),l.setBelow(a,null),k.setBelow(a,null))}function c(){var a;g.loPt==v.loPt&&u?(g.d0.setAbove(l,null),g.d1.setAbove(k,null),a=g.d1,l.setBelow(g.d0,null),k.setBelow(a,null),a=null):0<e.is_left_of(b,g.loPt)?(a=g.d1,g.d0.setAbove(l,
null),g.d1.setAbove(l,k),l.setBelow(g.d0,g.d1),k.setBelow(g.d1,null)):(a=g.d0,g.d0.setAbove(l,k),g.d1.setAbove(k,null),k.setBelow(g.d0,g.d1),l.setBelow(g.d0,null));return a}var e=this,d,f,h,m,n,s;b.upward?(m=b.vFrom.pt,d=b.vTo.pt,n=b.rootFrom,f=b.rootTo,s=b.sprev,h=b.snext):(m=b.vTo.pt,d=b.vFrom.pt,n=b.rootTo,f=b.rootFrom,s=b.snext,h=b.sprev);var u=!1;f=this.ptNode(d,m,f);h.is_inserted||(f=this.splitNodeAtPoint(f,d,!1));var g=f.trap;f=this.ptNode(m,d,n);s.is_inserted?u=!0:f=this.splitNodeAtPoint(f,
m,!0);var v=f.trap,l,k,p,q;for(d=this.trapezoids.length+2;g;){if(0>--d){console.log("ERR add_segment: infinite loop",g,b,this);return}if(!g.d0&&!g.d1){console.log("ERR add_segment: missing successors",g,b,this);return}h=g.sink;h.nodetype=PNLTRI.T_X;h.seg=b;h.trap=null;m=n=!0;q&&q.rseg==g.rseg?(n=!1,l=g,k=q,k.loPt=g.loPt,h.right=q.sink,l.sink=h.newLeft(PNLTRI.T_SINK,l)):p&&p.lseg==g.lseg?(m=!1,k=g,l=p,l.loPt=g.loPt,h.left=p.sink,k.sink=h.newRight(PNLTRI.T_SINK,k)):(l=g,k=this.cloneTrap(g),k.sink=h.newRight(PNLTRI.T_SINK,
k),l.sink=h.newLeft(PNLTRI.T_SINK,l));g.u0&&g.u1?g.usave?(g.uside==PNLTRI.S_LEFT?(n&&(k.setAbove(g.u1,g.usave),k.u0.d0=k,k.u1.d0=k),m&&(l.u1=null,l.u0.d0=l)):(n&&(k.setAbove(g.u1,null),k.u0.d0=k),m&&(l.setAbove(g.usave,g.u0),l.u0.d0=l,l.u1.d0=l)),l.usave=k.usave=null):(n&&(k.setAbove(g.u1,null),k.u0.d0=k),m&&(l.u1=null)):g.u0.d0&&g.u0.d1?g==g.u0.d1?(n&&(k.u0.d1=k,k.u1=null),m&&l.setAbove(null,null)):(n&&k.setAbove(null,null),m&&(l.u0.d0=l,l.u1=null)):m&&l.u0.setBelow(l,k);g.d0&&g.d1?h=c():(h=g.d0?
g.d0:g.d1,a(h));l.rseg=k.lseg=b;g.loPt!=v.loPt?(p=l,q=k,g=h):g=null}b.is_inserted=!0},find_first_inside:function(){for(var b=0,a=this.trapezoids.length;b<a;b++)if(this.inside_polygon(this.trapezoids[b]))return this.trapezoids[b];return null}};PNLTRI.Trapezoider=function(b){this.polyData=b;this.queryStructure=new PNLTRI.QueryStructure(this.polyData)};
