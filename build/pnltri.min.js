...
1;0<=b;b--)k.unshift(a[b])}var k=[],m=[];null==c&&(d=!0,b.uL?c=!0:b.dL?c=!1:(d=!1,c=b.uR?!0:!1));for(n([[b,c,d,a]]);m=k.shift();){var l;if((l=m[0])&&!l.monoDiag){if(!l.lseg||!l.rseg)return console.log("ERR alyTrap: lseg/rseg missing",l),l.monoDiag=PNLTRI.TRAP_NOSPLIT,k;a=m[1];b=m[2];var m=m[3],p;p=l.vHigh;var q=l.vLow;d=null;var r,f,g,h;l.uL?l.uR?(d=!0,r=l.uL,f=l.uR,g=PNLTRI.TRAP_MIDDLE):g=PNLTRI.TRAP_RIGHT:g=l.uR?PNLTRI.TRAP_LEFT:PNLTRI.TRAP_CUSP;l.dL?l.dR?(d=!1,r=l.dL,f=l.dR,h=PNLTRI.TRAP_MIDDLE):
h=PNLTRI.TRAP_RIGHT:h=l.dR?PNLTRI.TRAP_LEFT:PNLTRI.TRAP_CUSP;l.monoDiag=1+4*g+h;null!=d?g==PNLTRI.TRAP_CUSP||h==PNLTRI.TRAP_CUSP?(p=this.doSplit(m,q,p,b),n([[b?r:f,!a,b,m],[b?f:r,!a,!b,p]])):g==PNLTRI.TRAP_MIDDLE&&h==PNLTRI.TRAP_MIDDLE?(p=this.doSplit(m,q,p,b),b||(a=p,p=m,m=a),n([[l.uL,!1,!0,m],[l.dL,!0,!0,m],[l.uR,!1,!1,p],[l.dR,!0,!1,p]])):(d?(c=l.dL?l.dL:l.dR,g=h==PNLTRI.TRAP_LEFT):(c=l.uL?l.uL:l.uR,g=g==PNLTRI.TRAP_LEFT),a==d&&b==g?m=this.doSplit(m,q,p,g):(p=this.doSplit(m,q,p,!g),n([[g?r:f,!d,
