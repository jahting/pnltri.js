...
b,c.left)},add_segment:function(a){function b(){var a=f.uL||f.uR;a.dL&&a.dR?f==a.dR?(m.setAbove(null,null),l.setAbove(null,a),a.setBelow(a.dL,l)):(l.setAbove(null,null),m.setAbove(a,null),a.setBelow(m,a.dR)):(m.setAbove(a,null),l.setAbove(null,a),a.setBelow(m,l))}function c(a){f.vLow==s.vLow&&q?f.dL?(m.setBelow(a,null),l.setBelow(null,null),a.setAbove(m,a.uR)):(l.setBelow(null,a),m.setBelow(null,null),a.setAbove(a.uL,l)):(a.uL&&a.uR?a.uL==f?(a.usave=a.uR,a.uside=PNLTRI.S_LEFT,m.setBelow(a,null),l.setBelow(a,
null)):(a.usave=a.uL,a.uside=PNLTRI.S_RIGHT,m.setBelow(null,a),l.setBelow(null,a)):f.vLow==s.vLow?(m.setBelow(a,null),l.setBelow(null,a)):(m.setBelow(null,a),l.setBelow(a,null)),a.setAbove(m,l))}function d(){var b;f.vLow==s.vLow&&q?(f.dL.setAbove(m,null),f.dR.setAbove(null,l),b=f.dR,m.setBelow(f.dL,null),l.setBelow(null,b),b=null):0<e.is_left_of(a,f.vLow,!0)?(b=f.dR,f.dL.setAbove(m,null),f.dR.setAbove(m,l),m.setBelow(f.dL,f.dR),l.setBelow(null,f.dR)):(b=f.dL,f.dL.setAbove(m,l),f.dR.setAbove(null,
l),l.setBelow(f.dL,f.dR),m.setBelow(f.dL,null));return b}var e=this,k,g,h,n,p,q;a.upward?(n=a.vFrom,k=a.vTo,p=a.rootFrom,g=a.rootTo,q=a.sprev.is_inserted,h=a.snext.is_inserted):(n=a.vTo,k=a.vFrom,p=a.rootTo,g=a.rootFrom,q=a.snext.is_inserted,h=a.sprev.is_inserted);g=this.ptNode(k,n,g);h||(g=this.splitNodeAtPoint(g,k,!1));h=g.trap;if(h.uL||h.uR){g=this.ptNode(n,k,p);q||(g=this.splitNodeAtPoint(g,n,!0));var s=g.trap,f=h,m,l,t,r;for(k=this.trapArray.length+2;f;){if(0>--k){console.log("ERR add_segment: infinite loop",
f,a,this);return}if(!f.dL&&!f.dR){console.log("ERR add_segment: missing successors",f,a,this);return}g=f.sink;g.nodetype=PNLTRI.T_X;g.seg=a;g.trap=null;n=p=!0;r&&r.rseg==f.rseg?(p=!1,m=f,l=r,l.vLow=f.vLow,g.right=r.sink,g.left=new PNLTRI.QsNode(m)):t&&t.lseg==f.lseg?(n=!1,l=f,m=t,m.vLow=f.vLow,g.left=t.sink,g.right=new PNLTRI.QsNode(l)):(m=f,l=this.cloneTrap(f),g.right=new PNLTRI.QsNode(l),g.left=new PNLTRI.QsNode(m));f.uL&&f.uR?f.usave?(f.uside==PNLTRI.S_LEFT?(l.setAbove(f.uR,f.usave),l.uL.setBelow(l,
null),l.uR.setBelow(null,l)):(m.setAbove(f.usave,f.uL),m.uL.setBelow(m,null),m.uR.setBelow(null,m)),m.usave=l.usave=null):f.vHigh==h.vHigh?(l.setAbove(null,f.uR),l.uR.setBelow(null,l),m.setAbove(f.uL,null)):(p&&(l.setAbove(f.uR,null),l.uL.setBelow(l,l.uL.dR)),n&&m.setAbove(null,f.uL)):b();f.dL&&f.dR?n=d():(n=f.dL?f.dL:f.dR,c(n));m.rseg=l.lseg=a;f.vLow!=s.vLow?(t=m,r=l,f=n):f=null}a.is_inserted=!0}else console.log("ERR add_segment: missing trFirst.uX: ",h)},find_first_inside:function(){for(var a=0,
b=this.trapArray.length;a<b;a++)if(this.inside_polygon(this.trapArray[a]))return this.trapArray[a];return null}};PNLTRI.Trapezoider=function(a){this.polyData=a;this.queryStructure=new PNLTRI.QueryStructure(this.polyData)};
