...
l),l.setBelow(f.dL,f.dR),m.setBelow(f.dL,null));return b}var e=this,k,g,h,n,p,q;a.upward?(n=a.vFrom,k=a.vTo,p=a.rootFrom,g=a.rootTo,q=a.sprev.is_inserted,h=a.snext.is_inserted):(n=a.vTo,k=a.vFrom,p=a.rootTo,g=a.rootFrom,q=a.snext.is_inserted,h=a.sprev.is_inserted);g=this.ptNode(k,n,g);h||(g=this.splitNodeAtPoint(g,k,!1));h=g.trap;g=this.ptNode(n,k,p);q||(g=this.splitNodeAtPoint(g,n,!0));var s=g.trap,f=h,m,l,t,r;for(k=this.trapArray.length+2;f;){if(0>--k){console.log("ERR add_segment: infinite loop",
