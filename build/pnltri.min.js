...
b,c.right):this.ptNode(a,b,c.left)},add_segment:function(a){function b(a){f.loPt==r.loPt&&q?f.rseg==p?(a.u0=m,m.setBelow(a,null),n.setBelow(null,null)):(a.u1=n,n.setBelow(a,null),m.setBelow(null,null)):(a.u0&&a.u1&&(a.u0==f?(a.usave=a.u1,a.uside=PNLTRI.S_LEFT):(a.usave=a.u0,a.uside=PNLTRI.S_RIGHT)),a.setAbove(m,n),m.setBelow(a,null),n.setBelow(a,null))}function c(){var b;f.loPt==r.loPt&&q?(f.d0.setAbove(m,null),f.d1.setAbove(n,null),b=f.d1,m.setBelow(f.d0,null),n.setBelow(b,null),b=null):0<d.is_left_of(a,
f.loPt,!0)?(b=f.d1,f.d0.setAbove(m,null),f.d1.setAbove(m,n),m.setBelow(f.d0,f.d1),n.setBelow(f.d1,null)):(b=f.d0,f.d0.setAbove(m,n),f.d1.setAbove(n,null),n.setBelow(f.d0,f.d1),m.setBelow(f.d0,null));return b}var d=this,e,k,l,h,g,p;a.upward?(h=a.vFrom,e=a.vTo,g=a.rootFrom,k=a.rootTo,p=a.sprev,l=a.snext):(h=a.vTo,e=a.vFrom,g=a.rootTo,k=a.rootFrom,p=a.snext,l=a.sprev);var q=!1;k=this.ptNode(e,h,k);l.is_inserted||(k=this.splitNodeAtPoint(k,e,!1));var f=k.trap;k=this.ptNode(h,e,g);p.is_inserted?q=!0:k=
